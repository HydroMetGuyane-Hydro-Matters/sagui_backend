...
class AtmoAlertCategories(models.Model):
    ...
    label_fr = models.CharField(max_length=50, null=False, default='', blank=True)
    label_en = models.CharField(max_length=50, null=False, default='', blank=True)
    label_pt = models.CharField(max_length=50, null=False, default='', blank=True)
